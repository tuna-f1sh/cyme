        ...
        cyme)
            ...
            case "${prev}" in
                ...
                --filter-exclude)
                    ...
                    ;;
                --blocks)
                    COMPREPLY=($(compgen -W "bus-number device-number branch-position port-path sys-path driver icon vendor-id product-id vid-pid name manufacturer product-name vendor-name serial speed negotiated-speed speed-label negotiated-speed-label tree-positions bus-power bus-power-used extra-current-used bcd-device bcd-usb base-class sub-class protocol uid-class uid-sub-class uid-protocol class base-value last-event event-icon operation-mode negotiated-operation-mode speed-marketing-label negotiated-speed-marketing-label" -- "${cur}"))
                    return 0
                    ;;
                -b)
                    COMPREPLY=($(compgen -W "bus-number device-number branch-position port-path sys-path driver icon vendor-id product-id vid-pid name manufacturer product-name vendor-name serial speed negotiated-speed speed-label negotiated-speed-label tree-positions bus-power bus-power-used extra-current-used bcd-device bcd-usb base-class sub-class protocol uid-class uid-sub-class uid-protocol class base-value last-event event-icon operation-mode negotiated-operation-mode speed-marketing-label negotiated-speed-marketing-label" -- "${cur}"))
