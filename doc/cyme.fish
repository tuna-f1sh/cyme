...
speed-label\t'Advertised device speed as the USB-IF label string'
negotiated-speed-label\t'Negotiated device speed as the USB-IF label string'
...
protocol\t'Protocol value for interface provided by USB IF - only available when using libusb'
...
operation-mode\t'Advertised device speed as USB-IF Gen NxM operation mode string (e.g. \'USB 3.2 Gen 2x1\')'
negotiated-operation-mode\t'Negotiated device speed as USB-IF Gen NxM operation mode string'
speed-marketing-label\t'Advertised device speed as USB-IF recommended marketing label (e.g. \'USB 5 Gbps\')'
negotiated-speed-marketing-label\t'Negotiated device speed as USB-IF recommended marketing label'"
...
num-interfaces\t'Interfaces available for this configuration'
...
dev-path\t'The /dev/ device paths for the interface if any exist (Linux only)'
